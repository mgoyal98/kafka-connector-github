...
public class GitHubSinkConnectorConfig extends AbstractConfig {
  ...
  public GitHubSinkConnectorConfig(ConfigDef config, Map<String, String> parsedConfig) {
    super(config, parsedConfig);
  }

  public GitHubSinkConnectorConfig(Map<String, String> parsedConfig) {
