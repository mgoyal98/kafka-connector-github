...
public class GitHubSinkConnector extends SinkConnector {
  private static Logger log = LoggerFactory.getLogger(GitHubSinkConnector.class);
  private GitHubSinkConnectorConfig config;
  ...
  public void start(Map<String, String> map) {
    config = new GitHubSinkConnectorConfig(map);
  ...
  public ConfigDef config() {
    return GitHubSinkConnectorConfig.conf();
  }
}
